...
/**
 * Double card ringtone test(card 2).
...
public class Ringtone1Test extends InstrumentationTestCase {
    private static final String TAG = "MediaProvider.Ringtone1Test";
    ...
    public void setUp() throws Exception {
        ...
        mRingtone = RingtoneManager.getRingtone(mContext, Settings.System.DEFAULT_RINGTONE1_URI);
        ...
        mDefaultRingUri = RingtoneManager.getActualDefaultRingtoneUri(mContext,
                RingtoneManager.TYPE_RINGTONE1);
    }
    ...
    public void tearDown() throws Exception {
        ...
        RingtoneManager.setActualDefaultRingtoneUri(mContext, RingtoneManager.TYPE_RINGTONE1,
                mDefaultRingUri);
    ...
    public void testRingtone() throws Exception{
        ...
        Log.i(TAG, "ringtone title :"+mRingtone.getTitle(mContext));
        ...
        RingtoneManager.setActualDefaultRingtoneUri(mContext, RingtoneManager.TYPE_RINGTONE1, null);
        mRingtone = RingtoneManager.getRingtone(mContext, Settings.System.DEFAULT_RINGTONE1_URI);
        ...
        RingtoneManager.setActualDefaultRingtoneUri(mContext, RingtoneManager.TYPE_RINGTONE1, uri);
        mRingtone = RingtoneManager.getRingtone(mContext, Settings.System.DEFAULT_RINGTONE1_URI);
        assertTrue(mRingtone.getStreamType() == AudioManager.STREAM_RING);
        mRingtone.play();
