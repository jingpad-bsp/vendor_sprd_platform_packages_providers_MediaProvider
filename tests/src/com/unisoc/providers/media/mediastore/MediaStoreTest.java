...
public class MediaStoreTest {
    ...
    public void testGetStorageVolume() throws Exception {
        ...
        final Uri uri = ProviderTestUtils.stageMedia(R.raw.test_image, mExternalImages);
    ...
    public void testContributedMedia() throws Exception {
        ...
        try (AssetFileDescriptor fd = getContext().getResources()
                .openRawResourceFd(R.raw.test_image)) {
        ...
        ProviderTestUtils.stageFile(R.raw.test_image, file);
        inside = ProviderTestUtils.scanFileFromShell(file);
        outside = ProviderTestUtils.stageMedia(R.raw.test_image, mExternalImages);
